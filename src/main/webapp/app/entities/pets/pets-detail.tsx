...
export const PetsDetail = () => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="petsDetailsHeading">
          <Translate contentKey="petclinicApp.pets.detail.title">Pets</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="petclinicApp.pets.name">Name</Translate>
            </span>
          </dt>
          <dd>{petsEntity.name}</dd>
          <dt>
            <span id="birthdate">
              <Translate contentKey="petclinicApp.pets.birthdate">Birthdate</Translate>
            </span>
          </dt>
          <dd>{petsEntity.birthdate ? <TextFormat value={petsEntity.birthdate} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="petclinicApp.pets.type">Type</Translate>
          </dt>
          <dd>{petsEntity.type ? petsEntity.type.id : ''}</dd>
          <dt>
            <Translate contentKey="petclinicApp.pets.owner">Owner</Translate>
          </dt>
